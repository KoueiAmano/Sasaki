#!/usr/bin/env python3
"""Regenerate Sasaki/knowledge/INDEX.md from all knowledge entries.

Walks:
- Sasaki/knowledge/{library,pattern,gotcha,tool-quirk}/*.md  (cross-project)
- Sasaki/projects/*/.knowledge/*.md                          (project-specific)
...
def render(out: dict) -> str:
    lines = [
        ...
        "",
        "_Run `python3 Sasaki/scripts/gen-knowledge-index.py` to regenerate._",
        "",
    ]
    for cat in CATS:
        lines.append(f"## {cat}")
